hashtagApp.controller('D3Controller',['$scope', 'ioFactory', function( $scope, ioFactory){
    ...
    //$scope.ja = [{"count":9,"tag":"#방탄소년단"},{"count":7,"tag":"#BTS"},{"count":4,"tag":"#FIRE2ndWin"},{"count":3,"tag":"#MarkBam"},{"count":2,"tag":"#EXO"},{"count":1,"tag":"#เหนือแอน…"},{"count":1,"tag":"#อาร์มี่ยินดีด้วยนะ"},{"count":1,"tag":"#kookmin"},{"count":1,"tag":"#JIMIN"},{"count":1,"tag":"#ฝรั่งคือนิพพาน"}];
    ...
    ioFactory.io().then(function(io){
        ...
        socket.on('topTagByLangs', function(msg) {
          msg.forEach(function(d){
            //if(d.lang=="th") {
              $scope.$apply(function(){
                $scope[d.lang] = d.topTags;
                //$scope.sumOfTop[d.lang] = sumFunc($scope[d.lang]);
              });
            //}
          });
        });
